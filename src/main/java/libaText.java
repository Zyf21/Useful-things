...
import java.util.*;
public class libaText {
    public static  void main(String[] args) throws IOException {

        try (   PDDocument document = PDDocument.load(new File("pdfFiles/test6.pdf")) ) {
    ...
    public static class PdfBoxFinder extends PDFGraphicsStreamEngine {
        /**
